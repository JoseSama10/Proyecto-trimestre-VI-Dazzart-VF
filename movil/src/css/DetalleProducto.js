    ...
    imagenMobile: { width: '90%', height: 240, borderRadius: 12, backgroundColor: '#fff', resizeMode: 'contain', marginBottom: 10 },
    infoBoxMobile: { paddingHorizontal: 18, paddingBottom: 18 },
    ...
    cantidadLabelMobile: { fontWeight: 'bold', fontSize: 16, marginBottom: 4 },
        ...
        cantidadSelectTxtMobile: {
            fontSize: 16,
            color: '#222',
            textAlign: 'left',
        },
        modalCantidadOverlay: {
            flex: 1,
        ...
        modalCantidadCloseBtn: {
            alignSelf: 'flex-end',
            padding: 6,
        },
        modalCantidadCloseTxt: {
            color: '#3483fa',
            fontWeight: 'bold',
            fontSize: 15,
        },
    ...
    dropdownCantidadBtnAct: {
        backgroundColor: '#e3f0ff',
    },
    dropdownCantidadBtnTxt: {
        fontSize: 16,
        color: '#222',
    },
});
